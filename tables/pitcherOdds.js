...
export class PitcherOddsTable extends BaseTable {
    constructor(elementId) {
        ...
        this.propAbbrevMap = { 'Strikeouts': 'K', 'Hits Allowed': 'Hits', 'Walks': 'BB', 'Earned Runs': 'ER', 'Outs Recorded': 'Outs', 'Pitching Outs': 'Outs', 'Record a Win': 'Win' };
    }
    ...
    getColumns(isSmallScreen = false) {
        ...
        const kellyFormatter = (cell) => { const v = cell.getValue(); if (v == null || v === '' || v === '-') return '-'; const n = parseFloat(v); if (isNaN(n)) return '-'; const b = getBankrollValue('Pitcher Quarter Kelly %'); if (b > 0) return '$' + (n / 100 * b).toFixed(2); return n.toFixed(1) + '%'; };
