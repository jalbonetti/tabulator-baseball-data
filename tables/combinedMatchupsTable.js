...
export class MatchupsTable extends BaseTable {
    ...
    processPlayerData(data, type, gameId) {
        ...
        data.forEach(row => {
            ...
            // Check split type
            const splitId = row[splitField];// tables/combinedMatchupsTable.js - COMPLETE FIXED VERSION
import { BaseTable } from './baseTable.js';
import { createCustomMultiSelect } from '../components/customMultiSelect.js';
...
export class MatchupsTable extends BaseTable {
    ...
    sortBullpenSplits(splits, location) {
        ...
        splits.forEach(split => {
            ...
            if (splitId === 'R' || splitId === 'vs R' || splitId.includes('Right')) {
                if (splitId.includes('@')) {
            ...
            } else if (splitId.includes('@') || splitId === 'Full Season@' || splitId === 'Season @') {
